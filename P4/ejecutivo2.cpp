...
void TareaD() { Tarea( "D", milliseconds( 240) );  } // void TareaD() { Tarea( "D", milliseconds( 250) );  } Para la cuestion 2º
...
int main( int argc, char *argv[] )
{
   ...
   while( true ) // ciclo principal
   {
	 ...
	 if((steady_clock::now()-ini_sec)>milliseconds(500)){
...
/*                        CUESTIONES
   ...
   - Sí que habría un problema, porque no se cumplirían los ciclos de 500ms
     ya que hay alrededor de [7*10^-4ms, 8*10^-4ms] de retraso en cada iteración.
*/
