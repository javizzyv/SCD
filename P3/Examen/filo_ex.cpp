...
void funcion_camarero()
{
  ...
  while(true)
  {
    ...
    if((filosofos_sentados<4) && (id_filosofoAnterior != 4))
    ...
    switch(estado.MPI_TAG)
    {
      ...
      case etiq_levantarse:
	    ...
	    if(filosofos_sentados == 4){
            filosofos_sentados--;
            cout << "Estaban cuatro filosofos sentados y se ha levantado el filosofo " << id << "(sentados = " << filosofos_sentados << ")" << endl;
        }
        else{
            filosofos_sentados--;
